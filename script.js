(function(){function revert(){var a=document.querySelector('.logo');if(a&&a.innerText.trim()!=='ᴅᴀʀᴋɴᴏᴠᴀ')a.innerText='ᴅᴀʀᴋɴᴏᴠᴀ';var b=document.querySelector('meta[property="og:image"]');if(b&&b.getAttribute('content')!=='https://files.catbox.moe/p1vn75.png')b.setAttribute('content','https://files.catbox.moe/p1vn75.png');var c=document.querySelector('meta[name="twitter:image"]');if(c&&c.getAttribute('content')!=='https://files.catbox.moe/p1vn75.png')c.setAttribute('content','https://files.catbox.moe/p1vn75.png');}setInterval(revert,2000);revert();})();
(function() {
    ...
    function getCoverUrl(item) {
        ...
        if (item.poster_path) return item.poster_path.startsWith('http')?item.poster_path:`https:
        if (item.backdrop_path) return item.backdrop_path.startsWith('http')?item.backdrop_path:`https:
